...
function readJson(data) {
	...
	text += "<div class='balance'><span id='eth-balance'>ETH: " + cryptoRound(data.ETH.balance) + " ETH</span> | <span id='usd-balance'>$" + fiatRound(data.ETH.balance * data.ETH.price.rate) + "</span></div>";
